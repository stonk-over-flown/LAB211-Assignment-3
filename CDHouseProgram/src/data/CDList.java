        ...
        for (int i = 0; i < this.size(); i++) {
            if (this.get(i).getID().equals(input)) {
                ...
                do {
                    ...
                    newID = NTool.SC.nextLine().toUpperCase();
                    if (newID.isEmpty()) {
                ...
                do {
                    ...
                    newCollectionRaw = NTool.SC.nextLine();
